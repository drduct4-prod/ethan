        ...
        <div className="mx-auto max-w-7xl px-5 lg:px-10 relative z-10">
          <div className="max-w-4xl">
            ...
            <h1 className="hero-text text-5xl lg:text-8xl font-bold leading-[1] tracking-tight text-gray-900 mb-8">
              Maximum <span className="text-[#5E7AC4]">Suction.</span><br />
              Wall-to-Wall Clean.
            </h1>
            
            <p className="hero-text text-xl lg:text-2xl text-gray-500 leading-relaxed mb-12 max-w-2xl font-medium">
              Over time, dust and debris build up inside your central vacuum's hidden pipes, reducing airflow and spreading allergens. We perform a complete system purge to restore 100% factory suction.
            </p>
            ...
            <div className="hero-text flex flex-col sm:flex-row gap-5">
              ...
              <div className="flex items-center gap-4 px-2">
                ...
                <p className="text-sm font-semibold text-gray-500 italic">Trusted Central Vac Maintenance</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-5 lg:px-10">
          <div className="grid lg:grid-cols-3 gap-12">
            <div className="lg:col-span-1">
              <h2 className="text-4xl font-bold tracking-tight mb-6">Hidden Pipes, Hidden Dust</h2>
              <p className="text-gray-500 text-lg leading-relaxed">
                Most homeowners forget the miles of piping behind their walls. Static electricity causes fine dust to cling to these pipes, creating "slugs" that eventually block the system.
              </p>
            </div>
            <div className="lg:col-span-2 grid sm:grid-cols-2 gap-8">
              {[
                { icon: Activity, t: "Suction Restoration", d: "Removing pipe friction allows your motor to pull debris from the furthest inlet with ease." },
                { icon: Search, t: "Blockage Detection", d: "Professional camera inspection to find and remove toys, hair clogs, or construction debris." },
                { icon: Trash2, t: "Canister Decon", d: "Deep cleaning and sanitizing the main power unit and HEPA filtration assembly." },
                { icon: Focus, t: "Inlet Service", d: "Testing and sealing every wall valve to ensure zero vacuum pressure loss." }
              ].map((item, i) => (
      ...
      <section className="reveal-section py-24 bg-[#f9fafb]">
        <div className="mx-auto max-w-7xl px-5 lg:px-10">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-4xl lg:text-5xl font-bold mb-6">The System Purge Process</h2>
            <p className="text-gray-500 text-lg">We use specialized "tornado" nozzles to scrub your pipes from the inside out.</p>
          </div>

          <div className="grid md:grid-cols-5 gap-4">
            {[
              { n: "01", t: "Map", d: "Identifying all inlets and the main trunk line path." },
              { n: "02", t: "Analyze", d: "Digital vacuum pressure test at every port." },
              { n: "03", t: "Purge", d: "High-pressure mechanical scrubbing of in-wall pipes." },
              { n: "04", t: "Filter", d: "Deep cleaning or replacing the power unit filters." },
              { n: "05", t: "Verify", d: "Final CFM (Cubic Feet/Min) airflow certification." }
            ].map((step, i) => (
        ...
        <div className="mx-auto max-w-7xl px-5 lg:px-10">
          <div className="rounded-[40px] bg-[#0d0d0d] overflow-hidden text-white p-10 lg:p-20 relative">
             <div className="grid lg:grid-cols-2 gap-16 items-center">
                <div>
                  <h2 className="text-4xl lg:text-5xl font-bold mb-8">Bring Back <br/><span className="text-[#5E7AC4]">The Power.</span></h2>
                ...
                <div className="relative aspect-video rounded-2xl overflow-hidden shadow-2xl bg-gray-900">
                   <div className="absolute inset-0 bg-gradient-to-br from-[#5E7AC4]/20 to-transparent" />
                   <Image 
