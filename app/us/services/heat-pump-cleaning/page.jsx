        ...
        <div className="mx-auto max-w-7xl px-5 lg:px-10 relative z-10">
          <div className="max-w-4xl">
            ...
            <h1 className="hero-text text-5xl lg:text-8xl font-bold leading-[1] tracking-tight text-gray-900 mb-8">
              Peak <span className="text-[#5E7AC4]">Efficiency.</span><br />
              All-Season Comfort.
            </h1>
            
            <p className="hero-text text-xl lg:text-2xl text-gray-500 leading-relaxed mb-12 max-w-2xl font-medium">
              Don't let dirt drive up your energy bills. Our deep-coil cleaning and system calibration ensure your heat pump delivers maximum BTU output with minimum power consumption.
            </p>
            ...
            <div className="hero-text flex flex-col sm:flex-row gap-5">
              ...
              <div className="flex items-center gap-4 px-2">
                ...
                <p className="text-sm font-semibold text-gray-500 italic">Save up to 25% on Energy Bills</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-5 lg:px-10">
          <div className="grid lg:grid-cols-3 gap-12">
            <div className="lg:col-span-1">
              <h2 className="text-4xl font-bold tracking-tight mb-6">The Power of a Clean System</h2>
              <p className="text-gray-500 text-lg leading-relaxed">
                Heat pumps rely on airflow and heat exchange. Even a thin layer of grime on your coils can force the compressor to work twice as hard, leading to premature failure.
              </p>
            </div>
            <div className="lg:col-span-2 grid sm:grid-cols-2 gap-8">
              {[
                { icon: Droplets, t: "Chemical Coil Wash", d: "Removing oxidation and buildup from evaporator coils for better heat transfer." },
                { icon: Wind, t: "Airflow Optimization", d: "Deep cleaning blower wheels and fans to ensure consistent temperature distribution." },
                { icon: Activity, t: "Component Testing", d: "Proactive checking of capacitors and contactors to prevent emergency breakdowns." },
                { icon: Settings2, t: "Fin Straightening", d: "Repairing bent condenser fins to restore aerodynamic cooling efficiency." }
              ].map((item, i) => (
      ...
      <section className="reveal-section py-24 bg-[#f9fafb]">
        <div className="mx-auto max-w-7xl px-5 lg:px-10">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-4xl lg:text-5xl font-bold mb-6">Our 5-Point Tune-Up</h2>
            <p className="text-gray-500 text-lg">A comprehensive service designed for both indoor and outdoor units.</p>
          </div>

          <div className="grid md:grid-cols-5 gap-4">
            {[
              { n: "01", t: "Scan", d: "Infrared thermal imaging of the coils." },
              { n: "02", t: "Degrease", d: "Applying eco-friendly foaming coil cleaners." },
              { n: "03", t: "Flush", d: "High-pressure clearing of condensate drains." },
              { n: "04", t: "Verify", d: "Testing refrigerant levels and pressures." },
              { n: "05", t: "Calibrate", d: "Optimizing thermostat and cycle times." }
            ].map((step, i) => (
        ...
        <div className="mx-auto max-w-7xl px-5 lg:px-10">
          <div className="rounded-[40px] bg-[#0d0d0d] overflow-hidden text-white p-10 lg:p-20 relative">
             <div className="grid lg:grid-cols-2 gap-16 items-center">
                <div>
                  <h2 className="text-4xl lg:text-5xl font-bold mb-8">Extend Your <br/><span className="text-[#5E7AC4]">Unit's Life.</span></h2>
                ...
                <div className="relative aspect-video rounded-2xl overflow-hidden shadow-2xl bg-gray-900">
                   <div className="absolute inset-0 bg-gradient-to-br from-[#5E7AC4]/10 to-transparent" />
                   <Image 
