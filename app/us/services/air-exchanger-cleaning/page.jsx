        ...
        <div className="mx-auto max-w-7xl px-5 lg:px-10 relative z-10">
          <div className="max-w-4xl">
            ...
            <h1 className="hero-text text-5xl lg:text-8xl font-bold leading-[1] tracking-tight text-gray-900 mb-8">
              Pure Oxygen. <span className="text-[#5E7AC4]">Balanced.</span><br />
              Core Efficiency.
            </h1>
            
            <p className="hero-text text-xl lg:text-2xl text-gray-500 leading-relaxed mb-12 max-w-2xl font-medium">
              We specialize in deep-cleaning Heat Recovery Ventilators. By decontaminating the core and filters, we ensure your home exchanges stale air for crisp, outdoor purity.
            </p>
            ...
            <div className="hero-text flex flex-col sm:flex-row gap-5">
              ...
              <div className="flex items-center gap-4 px-2">
                ...
                <p className="text-sm font-semibold text-gray-500 italic">Certified Air Exchange Techs</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-5 lg:px-10">
          <div className="grid lg:grid-cols-3 gap-12">
            <div className="lg:col-span-1">
              <h2 className="text-4xl font-bold tracking-tight mb-6">Optimizing Your Recovery Core</h2>
              <p className="text-gray-500 text-lg leading-relaxed">
                A neglected air exchanger can become a source of humidity and pollutants. Our process restores your system to factory-spec performance.
              </p>
            </div>
            <div className="lg:col-span-2 grid sm:grid-cols-2 gap-8">
              {[
                { icon: ThermometerSnowflake, t: "Thermal Recovery", d: "Clean cores transfer heat up to 30% more effectively during extreme weather." },
                { icon: Filter, t: "HEPA Filtration", d: "Deep cleaning of intake screens and replacement of internal filters for maximum purity." },
                { icon: Gauge, t: "Airflow Balancing", d: "We calibrate supply and exhaust fans to maintain neutral house pressure." },
                { icon: Sparkles, t: "Pathogen Removal", d: "Anti-microbial treatment of the drainage system to eliminate stagnant odors." }
              ].map((item, i) => (
      ...
      <section className="reveal-section py-24 bg-[#f9fafb]">
        <div className="mx-auto max-w-7xl px-5 lg:px-10">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-4xl lg:text-5xl font-bold mb-6">Our Engineering Approach</h2>
            <p className="text-gray-500 text-lg">Beyond a simple wipe-down; we perform a full system reset.</p>
          </div>

          <div className="grid md:grid-cols-5 gap-4">
            {[
              { n: "01", t: "Diagnosis", d: "Checking motor amps and static pressure." },
              { n: "02", t: "Core Wash", d: "Chemical-free ultrasonic or manual wash." },
              { n: "03", t: "Vent Clear", d: "Clearing debris from outside intake hoods." },
              { n: "04", t: "Disinfect", d: "EPA-approved fogging of the unit cabinet." },
              { n: "05", t: "Calibration", d: "Final balancing for optimal air change." }
            ].map((step, i) => (
        ...
        <div className="mx-auto max-w-7xl px-5 lg:px-10">
          <div className="rounded-[40px] bg-[#0d0d0d] overflow-hidden text-white p-10 lg:p-20 relative">
             <div className="grid lg:grid-cols-2 gap-16 items-center">
                <div>
                  <h2 className="text-4xl lg:text-5xl font-bold mb-8">Performance <br/><span className="text-[#5E7AC4]">Guaranteed.</span></h2>
