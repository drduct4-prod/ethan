    ...
    provinces: [
      {
        ...
        cities: [
          ...
          "Richmond Hill", "Markham", "Brampton", "Mississauga", "North York",
          "Bradford", "Keswick", "Barrie", "Aurora", "East Gwillimbury", "Oakville",
          "Burlington", "Hamilton", "Brantford", "Kitchener", "Cambridge", "Waterloo",
          "Guelph", "St Catharines", "Niagara Falls", "Welland", "Woodstock",
          "St. Thomas", "London", "Windsor", "Essex", "Amherstburg", "Kingsville",
          "Lakeshore", "LaSalle", "Tilbury", "Chatham", "Ottawa",
        ],
      },
      {
        label: "Quebec",
        ...
        cities: [
          ...
          "Mirabel", "Sainte-Colomban", "Brossard", "Longueuil", "Boucherville",
          "Beloeil", "St-Bruno-de-Montarville", "Saint Hubert", "Saint Lambert",
          "Candiac", "Sainte Catherine", "Chateauguay", "Delson", "Saint Constant",
          "Chambly", "Kahnawake", "Saint Jean Sur Richelieu", "Marieville",
          "Sainte Julie", "Saint Hyacinthe",
        ],
      },
      {
        ...
        cities: [
          "Vancouver", "North Vancouver", "West Vancouver", "Surrey", "Burnaby",
          "Richmond", "Coquitlam",
        ],
      },
      {
  ...
  },
  {
    ...
    provinces: [
      ...
      },
      {
        ...
        slug: "florida",
        cities: [
          "Pensacola", "Naples", "Sarasota", "Tampa", "Orlando", "Miami",
          "Jacksonville", "Palm Beach", "Tallahassee",
        ],
      },
      {
        label: "Virginia",
      ...
      },
      {
        label: "California",
        slug: "california",
        cities: ["Los Angeles", "Sacramento", "Fresno", "San Diego", "San Jose"],
      },
      ...
      { label: "Massachusetts", slug: "massachusetts", cities: ["Boston"] },
      {
        ...
        cities: ["Charlotte", "Raleigh", "Durham", "Winston-Salem", "Charleston"],
      },
      {
        label: "Idaho",
        slug: "idaho",
      ...
      },
      {
        label: "Ohio",
        slug: "ohio",
        cities: ["Dayton", "Cincinnati", "Cleveland", "Columbus"],
      },
      {
        label: "Alabama",
        slug: "alabama",
