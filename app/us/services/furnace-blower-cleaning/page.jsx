        ...
        <div className="mx-auto max-w-7xl px-5 lg:px-10 relative z-10">
          <div className="max-w-4xl">
            ...
            <h1 className="hero-text text-5xl lg:text-8xl font-bold leading-[1] tracking-tight text-gray-900 mb-8">
              Quiet Power. <span className="text-[#5E7AC4]">Restored.</span><br />
              Blower Precision.
            </h1>
            
            <p className="hero-text text-xl lg:text-2xl text-gray-500 leading-relaxed mb-12 max-w-2xl font-medium">
              A dirty blower wheel can reduce airflow by up to 30% and cause motor burnout. We perform deep-fin cleaning and lubrication to keep your furnace running silently and efficiently.
            </p>
            ...
            <div className="hero-text flex flex-col sm:flex-row gap-5">
              ...
              <div className="flex items-center gap-4 px-2">
                ...
                <p className="text-sm font-semibold text-gray-500 italic">Extending Furnace Life by Years</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-5 lg:px-10">
          <div className="grid lg:grid-cols-3 gap-12">
            <div className="lg:col-span-1">
              <h2 className="text-4xl font-bold tracking-tight mb-6">The Heart of Your HVAC</h2>
              <p className="text-gray-500 text-lg leading-relaxed">
                The blower assembly is responsible for pushing air through your entire home. Dirt on the blades creates drag, imbalance, and mechanical stress.
              </p>
            </div>
            <div className="lg:col-span-2 grid sm:grid-cols-2 gap-8">
              {[
                { icon: RotateCw, t: "CFM Recovery", d: "Cleaning 'squirrel cage' fins restores full Cubic Feet per Minute airflow capacity." },
                { icon: Volume2, t: "Noise Reduction", d: "Eliminates the humming and vibration caused by unbalanced, dust-heavy blower wheels." },
                { icon: Zap, t: "Motor Longevity", d: "Reducing drag lowers the motor's operating temperature, preventing electrical shorts." },
                { icon: Gauge, t: "Static Pressure Fix", d: "Optimizes the pressure across your heat exchanger to prevent system cycling." }
              ].map((item, i) => (
      ...
      <section className="reveal-section py-24 bg-[#f9fafb]">
        <div className="mx-auto max-w-7xl px-5 lg:px-10">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-4xl lg:text-5xl font-bold mb-6">Technical Cleaning Process</h2>
            <p className="text-gray-500 text-lg">We don't just spray; we disassemble and restore.</p>
          </div>

          <div className="grid md:grid-cols-5 gap-4">
            {[
              { n: "01", t: "Isolate", d: "Full power cut and electrical safety check." },
              { n: "02", t: "Extract", d: "Removing the entire blower assembly unit." },
              { n: "03", t: "Deep Clean", d: "Manual brushing of every single fan blade." },
              { n: "04", t: "Lube", d: "Oiling motor bearings (if applicable) and shafts." },
              { n: "05", t: "Rebalance", d: "Reinstalling and verifying vibration-free spin." }
            ].map((step, i) => (
        ...
        <div className="mx-auto max-w-7xl px-5 lg:px-10">
          <div className="rounded-[40px] bg-[#0d0d0d] overflow-hidden text-white p-10 lg:p-20 relative">
             <div className="grid lg:grid-cols-2 gap-16 items-center">
                <div>
                  <h2 className="text-4xl lg:text-5xl font-bold mb-8">Stop the <br/><span className="text-[#5E7AC4]">Vibration.</span></h2>
